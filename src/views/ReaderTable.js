...
const ReaderTable = () => {
  ...
  const rows = [{"id":1,"name":"Indicio 1"},
                {"id":2,"name":"Indicio 2"},
                {"id":3,"name":"Indicio 3"}]
  ...
  const columns = [
    ...
    { field: 'id', headerName: 'ID', flex:1.25 },
    { field: 'penalty', headerName: 'Penalty', flex:1.25 },
    { field: 'penaltydate', headerName: 'Last Penalty Date', flex:1.25 },
