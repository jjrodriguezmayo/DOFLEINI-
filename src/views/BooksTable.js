...
const BooksTable = () => {
  ...
  const rows = [{"id":1,"title":"Indicio 1"},
                {"id":2,"title":"Indicio 2"},
                {"id":3,"title":"Indicio 3"}]
  ...
  const columns = [
    { field: 'title', headerName: 'Title', flex:1.00 },
    { field: 'summary', headerName: 'Summary', flex:1.25 },
    { field: 'genre', headerName: 'Genre', flex:1.25 },
    { field: 'author', headerName: 'Author', flex:1.25 },
    { field: 'allow', headerName: 'Can be Borrowed', flex:1.25 },
  ...
  return (
    ...
    <DataGrid
      ...
      columnVisibilityModel={{code:false}}
